...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://amortization-front-prueba.vercel.app", "http://localhost:5173", "https://amortization-front-prueba-q2xfjc2a9-alejandro-camperos-projects.vercel.app/"],
